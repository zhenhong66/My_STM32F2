...
USART_TypeDef* COM_USART[COMn] = {USB_COM}; 

GPIO_TypeDef* COM_TX_PORT[COMn] = {USB_COM_TX_GPIO_PORT};
 
GPIO_TypeDef* COM_RX_PORT[COMn] = {USB_COM_RX_GPIO_PORT};

const uint32_t COM_USART_CLK[COMn] = {USB_COM_CLK};

const uint32_t COM_TX_PORT_CLK[COMn] = {USB_COM_TX_GPIO_CLK};
 
const uint32_t COM_RX_PORT_CLK[COMn] = {USB_COM_RX_GPIO_CLK};

const uint16_t COM_TX_PIN[COMn] = {USB_COM_TX_PIN};

const uint16_t COM_RX_PIN[COMn] = {USB_COM_RX_PIN};
 
const uint8_t COM_TX_PIN_SOURCE[COMn] = {USB_COM_TX_SOURCE};

const uint8_t COM_RX_PIN_SOURCE[COMn] = {USB_COM_RX_SOURCE};
 
const uint8_t COM_TX_AF[COMn] = {USB_COM_TX_AF};
 
const uint8_t COM_RX_AF[COMn] = {USB_COM_RX_AF};
...
{
  GPIO_PORT[Led]->BSRRL = GPIO_PIN[Led];	//LEDOn
}
...
{
  GPIO_PORT[Led]->BSRRH = GPIO_PIN[Led]; 	//LEDOff 
}
