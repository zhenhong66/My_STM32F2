 ...
 */ 
#define USB_COM                        USART3
#define USB_COM_CLK                    RCC_APB1Periph_USART3
#define USB_COM_TX_PIN                 GPIO_Pin_10
#define USB_COM_TX_GPIO_PORT           GPIOC
#define USB_COM_TX_GPIO_CLK            RCC_AHB1Periph_GPIOC
#define USB_COM_TX_SOURCE              GPIO_PinSource10
#define USB_COM_TX_AF                  GPIO_AF_USART3
#define USB_COM_RX_PIN                 GPIO_Pin_11
#define USB_COM_RX_GPIO_PORT           GPIOC
#define USB_COM_RX_GPIO_CLK            RCC_AHB1Periph_GPIOC
#define USB_COM_RX_SOURCE              GPIO_PinSource11
#define USB_COM_RX_AF                  GPIO_AF_USART3
#define USB_COM_IRQn                   USART3_IRQn
