/**
  @page TCP echo client demonstration Readme file
 
  @verbatim
  ******************** (C) COPYRIGHT 2011 STMicroelectronics *******************
  * @file    tcp echo client/readme.txt 
  * @author  MCD Application Team
  * @version V1.0.2
  * @date    06-June-2011    
  * @brief   Description of the STM32F2x7 TCP echo client demonstration.
  ******************************************************************************
...
This directory contains a set of sources files that implement a TCP echo client
demonstration for STM32F2x7 devices.

Please note that for TCP echo client demonstration, LwIP v1.3.2 is used as the TCP/IP stack.
...
@par Project Directory contents
 ...
 - "inc": contains the demonstration firmware header files
    ...
    - inc/tcp_echoclient.h     header for tcp_echoclient.c
 ...
 - "src": contains the demonstration firmware source files
    ...
    - src/tcp_echoclient.c     tcp echoclient application
