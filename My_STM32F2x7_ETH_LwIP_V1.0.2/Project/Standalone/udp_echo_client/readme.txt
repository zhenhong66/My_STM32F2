/**
  @page UDP echo client demonstration Readme file
 
  @verbatim
  ******************** (C) COPYRIGHT 2011 STMicroelectronics *******************
  * @file    udp echo client/readme.txt 
  * @author  MCD Application Team
  * @version V1.0.2
  * @date    06-June-2011    
  * @brief   Description of the STM32F2x7 UDP echo client demonstration.
  ******************************************************************************
...
This directory contains a set of sources files that implement a UDP echo client 
demonstration for STM32F2x7 devices. 

Please note that for UDP echo client demonstration, LwIP v1.3.2 is used as the TCP/IP stack. 
...
@par Project Directory contents 
 ...
 - "inc": contains the demonstration firmware header files 
    ...
    - inc/udp_echoclient.h     header for udp_echoclient.c                             
 ...
 - "src": contains the demonstration firmware source files
    ...
    - src/udp_echoclient.c     udp echoclient application  
...
@par Hardware and Software environment  
  ...
  - This example has been tested with the following environments: 
     ...
     - echotool: PC utility (Utilities\PC_Software\Server) is used as echo 
       server that sends back every incoming data. 
