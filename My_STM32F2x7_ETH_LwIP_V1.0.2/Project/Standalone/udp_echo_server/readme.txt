/**
  @page UDP echo server demonstration Readme file
 
  @verbatim
  ******************** (C) COPYRIGHT 2011 STMicroelectronics *******************
  * @file    udp echo server/readme.txt
  * @author  MCD Application Team
  * @version V1.0.2
  * @date    06-June-2011
  * @brief   Description of the STM32F2x7 UDP echo server demonstration.
  ******************************************************************************
...
This directory contains a set of sources files that implement a UDP echo server 
demonstration for STM32F2x7 devices.

Please note that for UDP echo server demonstration, LwIP v1.3.2 is used as the TCP/IP stack.
...
@par Project Directory contents 
 ...
 - "inc": contains the demonstration firmware header files 
    ...
    - inc/udp_echoserver.h     header for udp_echoserver.c
 ...
 - "src": contains the demonstration firmware source files
    ...
    - src/udp_echoserver.c     udp echoserver application
