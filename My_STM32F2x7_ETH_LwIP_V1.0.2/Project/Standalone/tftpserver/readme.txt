/**
  ...
  * @file    tftpserver/readme.txt
  * @author  MCD Application Team
  * @version V1.0.2
  * @date    06-June-2011
  * @brief   Description of the STM32F2x7 tftp server demonstration.
  ******************************************************************************
...
This directory contains a set of sources files that implement a tftp server 
demonstration for STM32F2x7 devices. 

Please note that for tftp server demonstration, LwIP v1.3.2 is used as the TCP/IP stack.
...
@par Project Directory contents
 ...
 - "inc": contains the demonstration firmware header files
    ...
    - inc/tftputils.h          header for tftputils.c
 ...
 - "src": contains the demonstration firmware source files
    ...
    - src/tftpserver.c         tftp server application
    - src/tftputils.c          tftp server utilities functions
...
@par Hardware and Software environment
  ...
  - This example has been tested with the following environments:
     - STM322xG-EVAL board
     - TFTP client: PC utility TFTPD32 (http://tftpd32.jounin.net/) is used as
       a DHCP server and a TFTP client
