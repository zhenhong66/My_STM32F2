...
#define TFTPSERVER_THREAD_PRIO    ( tskIDLE_PRIORITY + 3 )
...
void tftp_server_init()
{
  sys_thread_new("TFTP", tftp_server_thread, NULL, DEFAULT_THREAD_STACKSIZE, TFTPSERVER_THREAD_PRIO);
}
